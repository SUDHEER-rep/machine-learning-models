...
righteye_cascade    = cv2.CascadeClassifier('cascades/data/haarcascade_righteye_2splits.xml')
lefteye_cascade    = cv2.CascadeClassifier('cascades/data/haarcascade_lefteye_2splits.xml')
#nose_cascade        = cv2.CascadeClassifier('cascades/third-party/Nose18x15.xml')
glasses             = cv2.imread("sudheer.png", -1)
